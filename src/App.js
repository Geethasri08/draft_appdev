...
const App = () => {
  ...
  return (
    <AuthProvider>
      <Router>
        <AuthConsumerComponent toggleSidebar={toggleSidebar} openSidebarToggle={openSidebarToggle} staffData={staffData} setStaffData={setStaffData} handleEdit={handleEdit} handleDelete={handleDelete} handleAdd={handleAdd} handleUpdate={handleUpdate} editingStaff={editingStaff} />
      </Router>
    </AuthProvider>
  );
}
